...
(function() {
  var EH, ERR, app, authUser, bcrypt, createAccount, createPendingAction, createRoom, createUser, createUserSession, crypto, executeAction, executePendingAction, express, fillMessageData, generateID, getUserDetails, hash, iced, io, linkUserToAccount, mustache, pushMessage, rc, redis, redis_store, roomHasUser, sessions, tmpl, verifyUser, viewPath, __iced_k, __iced_k_noop;
  ...
  hash = function(txt) {
    return crypto.createHash('sha256').update(txt).encoding('hex');
  };
  ...
  */
  ...
  createAccount = function(details, cb) {
    var account, e, exists, uk, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    account = details.accountid;
    uk = details.userkey;
    if (!account) cb(ERR('No account name specified'));
    if (!uk) cb(ERR('No user associated with the account'));
    (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        parent: ___iced_passed_deferral,
        filename: "app.coffee",
      ...
      rc.sismember('accounts', account, __iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
            e = arguments[0];
            return exists = arguments[1];
      ...
      if (typeof e !== "undefined" && e !== null) return cb(e);
      if (exists === 1) return cb(ERR('An account with this name already exists'));
      rc.hmset('account:' + account, {
        'accountid': account,
        'created_userkey': uk
      });
  ...
  createPendingAction = function(action, details, cb) {
    var e, h, key, whatever, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        parent: ___iced_passed_deferral,
        filename: "app.coffee",
        funcname: "createPendingAction"
      });
      rc.generateID('action', __iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
            e = arguments[0];
      ...
      if (typeof e !== "undefined" && e !== null) cb(e);
      h = hash(key);
      awat(rc.hmset('action:' + h, details, __iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
            e = arguments[0];
            return whatever = arguments[1];
          };
        })(),
        lineno: 145
      })));
  ...
  executePendingAction = function(actionhash, cb) {
    var details, e, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        parent: ___iced_passed_deferral,
        filename: "app.coffee",
        funcname: "executePendingAction"
      });
      rc.hgetall('action:' + actionhash, __iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
            e = arguments[0];
            return details = arguments[1];
          };
        })(),
        lineno: 151
      }));
      ...
      if (!(typeof e !== "undefined" && e !== null)) cb(e);
      if (!details) cb(ERR('Invalid Action'));
      return executeAction(details, cb);
    });
  };

  executeAction = function(details, cb) {
    var accountid, uk;
    switch (details.action) {
      case 'useraccountlink':
        accountid = details.accountid;
        uk = details.uk;
        if (!(accountid != null)) cb(ERR('Invalid Account'));
        if (!(uk != null)) cb(ERR('Invalid user for account'));
        return linkUserToAccount(accountid, uk, cb);
      default:
        return cb(ERR('Invalid action:' + details.action));
    }
  };

  linkUserToAccount = function(accountid, uk, cb) {
    var e, exists, userdetails, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        parent: ___iced_passed_deferral,
        filename: "app.coffee",
        funcname: "linkUserToAccount"
      });
      rc.sismember('accounts', accountid, __iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
            e = arguments[0];
            return exists = arguments[1];
      ...
      if (typeof e !== "undefined" && e !== null) cb(e);
      if (exists !== 1) cb(ERR('Invalid account:' + accountid));
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "app.coffee",
        ...
        getUserDetails(uk, __iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
              e = arguments[0];
              return userdetails = arguments[1];
            };
          })(),
          lineno: 172
        }));
        ...
        if (typeof e !== "undefined" && e !== null) cb(e);
        if (!userdetails) cb(ERR('Invalid user'));
        return rc.sadd('accountusers:' + accountid, uk, cb);
      });
    });
  };

  getUserDetails = function(uk, cb) {
    return rc.hgetall('user:' + uk, cb);
  };
