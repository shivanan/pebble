...
(function() {
  var EH, app, createUser, express, fillMessageData, generateID, getUserDetails, iced, io, mustache, pushMessage, rc, redis, redis_store, sessions, tmpl, viewPath, __iced_k, __iced_k_noop;
  ...
  */
  ...
  createUser = function(details, cb) {
    var e, hash, salt, uk, user, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    ...
    (function(__iced_k) {
      ...
      (function(__iced_k) {
        ...
        (function(__iced_k) {
          ...
          bcrypt.hash(details.password, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                e = arguments[0];
          ...
          if (typeof e !== "undefined" && e !== null) return cb(e, null);
          rc.het('uk:' + uk, 'userkey', uk);
          rc.het('uk:' + uk, 'name', details.name);
          rc.het('uk:' + uk, 'password', hash);
          user = {
            userkey: uk,
            name: details.name,
            password: hash
  ...
  app.post('/createuser', function(req, resp) {
    var e, pwd, un, user, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    un = req.query.name;
